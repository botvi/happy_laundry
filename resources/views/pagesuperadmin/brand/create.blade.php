          ...
          <div class="row align-items-center">
            <div class="col-md-12">
              <ul class="breadcrumb">
                ...
                <li class="breadcrumb-item" aria-current="page">Tambah Brand</li>
              </ul>
            </div>
            <div class="col-md-12">
              <div class="page-header-title">
                <h2 class="mb-0">Tambah Brand Baru</h2>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="col-sm-8">
          ...
          <div class="card">
            <div class="card-header">
              <h5><i class="fas fa-plus-circle me-2"></i>Form Tambah Brand</h5>
            </div>
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group mb-3">
                            <label class="form-label">Logo Brand <span class="text-danger">*</span></label>
                            <input type="file" 
                                   name="logo_brand" 
                    ...
                    <div class="col-md-6">
                        <div class="form-group mb-3">
                            ...
                            <select name="status_brand" 
                                ...
                                <option value="active" {{ old('status_brand') == 'active' ? 'selected' : '' }}>Aktif</option>
                                <option value="inactive" {{ old('status_brand') == 'inactive' ? 'selected' : '' }}>Tidak Aktif</option>
                            </select>
                            @error('status_brand')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
